...
namespace Framework
{
    ...
    public class Utils
    {
        ...
        */
        ...
        /// <summary>
        /// Convierte en DateTime la cadena pasada como argumento, en caso de que el cast no sea posible, devuelve el valor 
        /// mínimo de un DateTime.
        /// </summary>
        /// <param name="dateValue">Cadena a convertir en DateTime</param>
        /// <returns>DateTime obtenido por la conversión.</returns>
        public static DateTime JqxDateTimeParse(object dateValue) {
            string date = Utils.IsNull(dateValue,string.Empty);
            try
            {
                return DateTime.ParseExact(date, "ddd MMM dd yyyy HH:mm:ss 'GMT'zzz", CultureInfo.InvariantCulture);
            }
            catch (Exception)
            {
